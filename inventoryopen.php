<html>
    <head>
        ...
        <link rel="stylesheet" href="inventoryopen.css">
    ...
    <ul>
        ...
        <div class="banner-title">
            ...
            <div class="btn">
                <button type="button" class="btn"> <a href="http://localhost:8080/orphan/form3.php">Create Inventory</a></button>
                <button type="button" class="btn"> <a href="http://localhost:8080/orphan/form4.php">Add Inventory</a></button>
            </div>
        </div>
        </div>
    </body>
