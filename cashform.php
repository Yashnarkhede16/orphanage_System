...
<tr>
<td>date<td><input type="date" placeholder="date" name="date" required></td></tr>


<tr>
<td>Donation Amounts Rs<td><input type="text"  placeholder="donationamountrs" name="donationamountrs" required</td></tr>
<tr>
<td>Mobile No<td><input type="number" placeholder="mobileno" name="mobileno"></td></tr>
<tr>
